        ...
        <div class="container">
            ...
            <section class="main">
                    <form class="form-4">
                        ...
                        <p>
                            <input type="submit" name="submit_EC" value="Continuar" onclick="validLogin();">
                        </p>       
                    </form>​
            </section>
       </div>
...
<%-- start web service invocation --%>
    ...
    try {
        ...
        String flag = request.getParameter("submit_EC");
        ...
        if("Continuar".equals(flag)) {
            ...
            if("".equals(id) || "".equals(contraseña)) {
                ...
                Boolean result = port.verificarEstacionClave(id, contraseña);
                Boolean aux = true;
